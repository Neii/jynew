...
--Talk(0, "哇塞！好险我不是买”大补帖”．", "talkname0", 1);
--Talk(114, "是的．唯有尊重智慧财产权的消费者，才是最可爱的．好了，接下来就要靠你自己了．祝你幸运．因为唯有完成本游戏，你才能离开这个”游戏世界”，回到现实的世界里．．．．", "talkname114", 0);
--Talk(0, "等会等会．．．．你不给我一点提示吗？", "talkname0", 1);
--Talk(114, "难道你没先看说明书吗？", "talkname114", 0);
--Talk(0, "抱歉！我不习惯先看说明书的．", "talkname0", 1);
--Talk(114, "你们这些人都是这样的，自以为厉害，都不看说明书．", "talkname114", 0);
--Talk(0, "好啦，下次我一定会先看．麻烦给点提示，比如说，这游戏的目的是什么？", "talkname0", 1);
--Talk(114, "这要留给你自己到游戏中去找寻，现在不能告诉你．不过．．．", "talkname114", 0);
--Talk(0, "不过什么？", "talkname0", 1);
--Talk(114, "不过我还是给你一点提示．游戏中有一个很重要的人，你必须先找到他．这个人懂的东西非常的多，你找到他后，就可以明了到游戏的大概及其目的了．而且也唯有先找到他，游戏中的许多场景才会打开，让你可以进入．在此之前，你所能去的地方只有客栈以及他家和这儿．所以你得赶快找到他．", "talkname114", 0);
--Talk(0, "这个人是谁？", "talkname0", 1);
--Talk(114, "什么都跟你说的话，游戏还有乐趣吗？", "talkname114", 0);
--Talk(0, "这．．", "talkname0", 1);
--Talk(114, "别担心，游戏才刚开始，不会太难的．等会出了这里后，到对面的客栈打听一下就有消息了．不过可别忘了这游戏的背景是古代，所以注意一下你的言谈举止．对了，忘记告诉你，本游戏是采”有死亡”的设计，所以．．愿主保佑你！", "talkname114", 0);
--Talk(0, "我最怕的就是这样了！都什么年头了，还设计这种”死亡制”的游戏．你们喜欢复古啊！", "talkname0", 1);
--Talk(114, "别怕，这房内为你准备了一些基本物品，都放在各种箱子中．这其中有些药丸，在你生命垂危时可以派上用场的．另外，你身上好像有些东西是从现代带过来的，也可以派上用场．而且看你的资料，似乎也会一点拳法，没问题的．", "talkname114", 0);
